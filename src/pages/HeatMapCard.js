        ...
        <div className="heatmap-content">
          <div className="user-info">
            <div className="avatar-box">
              ...
              <p className='emp' style={{color:'#4B5563', fontSize:'16px', marginTop:'5px'}}>EMP ID : {user.empId}</p>
            </div>
          </div>
              ...
              <div className="time-cards">
                <div className="time-card">
                  <div className="time-icon">
                    <FaRegClock className='clock-icon' size={24} color="#ee4a01" />
                  </div>
            ...
            {["Module 1", "Module 2", "Module 3", "Module 4"].map((mod, idx) => (
              <div key={mod} className="module-wrapper">
                ...
                <div className="module-card">
                  <div className="time-icon">
                    <FaUsers className='people-icon' size={24} color="#ee4a01" />
                  </div>
